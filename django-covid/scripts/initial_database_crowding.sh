...
# psql -d covid -c "\COPY dashboard_provincia(data,stato,codice_regione,denominazione_regione,codice_provincia,denominazione_provincia,sigla_provincia,lat,long,totale_casi,note_it,note_en) FROM '$PROVINCE_DIR/dpc-covid19-ita-province.csv' DELIMITER ',' CSV HEADER;"
